        ...
        content = {
            Column(
                ...
                Row(
                    ...
                    Text(text = newsItem?.keywords?.joinToString(", ") ?: "", style = MaterialTheme.typography.body2)
                }
                Button(
                    onClick = {
                    ...
                    Text(stringResource(R.string.full_story), style = MaterialTheme.typography.button)
                }
            }
        }
    )
